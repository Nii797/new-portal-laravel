                    ...
                    <div class="col-md-6">
                        <div class="post">
                            <a class="post-img" href="#">
                                <img src="{{asset('uploads/'.$all->gambar)}}" alt="" height="250px" width="250px">
                            </a>
                            <div class="post-body">
                                <div class="post-meta">
            ...
            <div class="col-md-4">
                ...
                <div class="aside-widget">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="#">
                            <img src="{{asset('uploads/'.$terkait->gambar)}}" alt="" width="80px" height="80px">
                        </a>
                        <div class="post-body">
                            <h3 class="post-title">
                                <a href="{{ route('artikel.detail',$terkait->judul) }}">
                                    {{ $terkait->judul }}
                                </a>
                            </h3>
                        </div>
